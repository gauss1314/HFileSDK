...
public:
    ...
    {
        return Status{Code::IoError, std::move(msg)};
    }
    static Status InvalidArg(std::string msg)
    {
        return Status{Code::InvalidArg, std::move(msg)};
    }
    ...
    {
        return Status{Code::NotSupported, std::move(msg)};
    }
    static Status Internal(std::string msg)
    {
        return Status{Code::Internal, std::move(msg)};
    }
