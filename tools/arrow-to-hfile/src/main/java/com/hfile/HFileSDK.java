...
public class HFileSDK {
     ...
     *                                            Example: {@code ["_hoodie_commit_time","_hoodie_file_name"]}
     *   <li>{@code excluded_column_prefixes}   — JSON string array of column name prefixes to exclude.
     *                                            Any column whose name starts with a listed prefix is dropped.
     *                                            Example: {@code ["_hoodie"]} drops all five Hudi metadata
     *                                            columns automatically.
     * </ul>
     *
     * <h3>Hudi / CDC 元数据列过滤示例</h3>
     * <pre>{@code
     * sdk.configure("""
     *     {
     *       "compression":               "lz4",
     ...
     *     }
     *     """);
     * // Drops: _hoodie_commit_time, _hoodie_commit_seqno, _hoodie_record_key,
     * //        _hoodie_partition_path, _hoodie_file_name
     * //
     * // Original schema: [0]_hoodie_commit_time...[4]_hoodie_file_name [5]STARTTIME [6]IMSI
     * // Filtered schema: [0]STARTTIME [1]IMSI ...
     * //
     * // rowKeyRule indices refer to the FILTERED schema — same as a plain Arrow file:
     * int rc = sdk.convert(arrow, hfile, table, "STARTTIME,0,false,10#IMSI,1,true,15");
     * }</pre>
     *
